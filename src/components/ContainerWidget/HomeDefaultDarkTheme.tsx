  ...
  return (
    <MainContainer theme={theme}>
      ...
      <VideoSection>
       ...
       <Container>
        <SectionTitle theme={theme}>Art</SectionTitle>
        <ArtGallery>
          {artworks.map((artwork) => (
            <ArtItem key={artwork.id}>
      ...
      <SocialLinks>
        <SocialLink theme={theme}>
          <SocialIcon>
            ...
            <SocialText theme={theme}>Olivabaker</SocialText>
          </SocialIcon>
          <SocialArrow>
        ...
        {/* Додайте ще 2 соціальні посилання за аналогією */}
      </SocialLinks>
